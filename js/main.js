    ...
    async function initDashboard() {
        ...
        try {
            ...
            if (settings && settings.ai_config) {
                sessionStorage.setItem('ai_config', JSON.stringify(settings.ai_config));
            }
        } catch (e) {
        ...
        html += `<div class="form-grid">
            ...
            <div class="form-group">
                <label style="display:flex; justify-content:space-between; align-items:center;">
                    Title
                    <button type="button" id="${prefix}-ai-assist-btn" class="ai-assist-btn" title="AI Description Generator">✨ AI Assist</button>
                </label>
